...
export function HomePage() {
  return <>
    ...
    <section className="home-tools"><PageHeader eyebrow="Ferramentas" title="Escolha por onde começar" description="Cada produto tem uma responsabilidade clara e compartilha a mesma fundação de interface."/ >
